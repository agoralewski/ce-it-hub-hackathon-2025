...
urlpatterns = [
    ...
    path(
        "racks/<int:rack_id>/shelves/create/", views.shelf_create, name="shelf_create"
    ),
    ...
    path(
        ...
        views.add_item_to_shelf,
        name="add_item_to_shelf",
    ),
    path(
        "assignments/<int:pk>/remove/",
        views.remove_item_from_shelf,
    ...
    path(
        ...
        views.autocomplete_categories,
        name="autocomplete_categories",
    ),
    path(
        "api/autocomplete/items/", views.autocomplete_items, name="autocomplete_items"
    ),
    path(
        "api/autocomplete/manufacturers/",
        views.autocomplete_manufacturers,
