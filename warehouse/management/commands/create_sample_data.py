    ...
    def handle(self, *args, **kwargs):
        ...
        item_data = [
            ...
            },
            {
                ...
                "category": "Elektronika",
                "description": "Bezprzewodowa myszka Logitech",
                "manufacturer": "Logitech",
            },
            {
                "name": "Klocki Lego",
                "category": "Zabawki",
                "description": "Zestaw klocków Lego City",
                "manufacturer": "Lego",
            },
            {
                "name": "Miś pluszowy",
                "category": "Zabawki",
                "description": "Duży pluszowy miś",
                "manufacturer": "TeddyToys",
            },
            {
                "name": "Harry Potter",
                "category": "Książki",
                "description": "Książka Harry Potter i Kamień Filozoficzny",
            ...
            },
            {
                "name": "Kurtka zimowa",
                "category": "Ubrania",
                "description": "Zimowa kurtka dla dziecka",
                "manufacturer": "Columbia",
            },
            {
                "name": "Zeszyt A4",
                "category": "Artykuły szkolne",
                "description": "Zeszyt 80 kartek w kratkę",
                "manufacturer": "Oxford",
            },
            {
                "name": "Długopisy",
                "category": "Artykuły szkolne",
                "description": "Zestaw 10 kolorowych długopisów",
                "manufacturer": "Bic",
            },
        ]
        ...
        for item_info in item_data:
            ...
            category = next(
                (c for c in categories if c.name == item_info["category"]),
                categories[0],
            )
        ...
        for item in items:
            ...
            for _ in range(random.randint(1, 3)):  # Assign each item to 1-3 shelves
                ...
                assignment, created = ItemShelfAssignment.objects.get_or_create(
                    item=item, shelf=shelf, defaults={"quantity": quantity_on_shelf}
                )
                if created:
                    self.stdout.write(
                        f"Assigned {quantity_on_shelf} of {item.name} to {shelf.name}"
                    )
